...
class NewDreamVersionViewController: UIViewController,
    UITextFieldDelegate,
    UITextViewDelegate,
    ...
    init() {
        ...
        shareTapRecognizer = UITapGestureRecognizer(target: self, action: #selector(NewDreamVersionViewController.shareTapped))
        keepTapRecognizer = UITapGestureRecognizer(target: self, action: #selector(NewDreamVersionViewController.keepTapped))
        dreamTitleLabel.addTarget(self, action: #selector(NewDreamVersionViewController.updateButton), for: .editingChanged)
    ...
    override func viewDidLoad() {
        ...
        cancelButton.addTarget(self, action: #selector(NewDreamVersionViewController.cancelTapped), for: .touchUpInside)
